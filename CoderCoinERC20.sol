...
contract CoderCoinERC20 {
    string public constant _myTokeName = 'CoderCoin Token';//change here
    string public constant _mySymbol = 'CJC';//change here
...
contract MyAdvancedToken is owned, CoderCoinERC20 {
    ...
    function MyAdvancedToken(
        ...
        string tokenName,
        string tokenSymbol
    ) CoderCoinERC20(initialSupply, tokenName, tokenSymbol) public {}
